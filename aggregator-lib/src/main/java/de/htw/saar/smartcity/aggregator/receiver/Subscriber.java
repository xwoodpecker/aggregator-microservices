...
import de.htw.saar.smartcity.aggregator.utils.Utils;
...
public abstract class Subscriber implements MqttCallback {
     ...
     */
    public Subscriber(MicroserviceApplicationProperties applicationProperties, MeasurementHandler measurementHandler) {
